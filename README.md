This is my first exercise using java language to create projects, it only contains a few files that show the initial sintaxis and the basic usage of it on programming.
